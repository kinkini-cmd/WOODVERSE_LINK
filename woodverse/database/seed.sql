...
TRUNCATE TABLE customization_requests, product_customizations, paint_options, fabric_options, messages, quotations, orders, products, vendors, users RESTART IDENTITY CASCADE;
...
INSERT INTO fabric_options (id, name, color, material, price_per_unit, stock_quantity, image_url)
VALUES
  ('00000000-0000-4000-8000-000000000701', 'Linen Cream', '#F5F0E8', 'Linen', 8500.00, 120, '/assets/fabric-linen-cream.png'),
  ('00000000-0000-4000-8000-000000000702', 'Velvet Navy', '#1B2A4A', 'Velvet', 12000.00, 45, '/assets/fabric-velvet-navy.png'),
  ('00000000-0000-4000-8000-000000000703', 'Cotton Beige', '#E8DCC8', 'Cotton', 6500.00, 200, '/assets/fabric-cotton-beige.png'),
  ('00000000-0000-4000-8000-000000000704', 'Wool Charcoal', '#36454F', 'Wool', 15000.00, 30, '/assets/fabric-wool-charcoal.png'),
  ('00000000-0000-4000-8000-000000000705', 'Polyester Grey', '#A0A0A0', 'Polyester', 4500.00, 300, '/assets/fabric-polyester-grey.png');

INSERT INTO paint_options (id, name, color_hex, finish_type, price_per_unit, stock_quantity, image_url)
VALUES
  ('00000000-0000-4000-8000-000000000801', 'Matte Walnut', '#5D4037', 'Matte', 3200.00, 150, '/assets/paint-matte-walnut.png'),
  ('00000000-0000-4000-8000-000000000802', 'Gloss White', '#FFFFFF', 'Gloss', 2800.00, 180, '/assets/paint-gloss-white.png'),
  ('00000000-0000-4000-8000-000000000803', 'Satin Oak', '#C19A6B', 'Satin', 3500.00, 90, '/assets/paint-satin-oak.png'),
  ('00000000-0000-4000-8000-000000000804', 'Matte Black', '#1A1A1A', 'Matte', 3000.00, 120, '/assets/paint-matte-black.png'),
  ('00000000-0000-4000-8000-000000000805', 'Eggshell Ivory', '#FFFFF0', 'Eggshell', 2600.00, 210, '/assets/paint-eggshell-ivory.png');

INSERT INTO product_customizations (id, product_id, customization_type, available_fabric_ids, available_paint_ids, price_adjustment)
VALUES
  ('00000000-0000-4000-8000-000000000901', '00000000-0000-4000-8000-000000000301', 'sofa', ARRAY['00000000-0000-4000-8000-000000000701','00000000-0000-4000-8000-000000000702','00000000-0000-4000-8000-000000000703'], ARRAY['00000000-0000-4000-8000-000000000801','00000000-0000-4000-8000-000000000802'], 18500.00),
  ('00000000-0000-4000-8000-000000000902', '00000000-0000-4000-8000-000000000314', 'chair', ARRAY['00000000-0000-4000-8000-000000000703','00000000-0000-4000-8000-000000000705'], ARRAY['00000000-0000-4000-8000-000000000803','00000000-0000-4000-8000-000000000804'], 9500.00);

INSERT INTO customization_requests (id, customer_id, product_id, selected_fabric_id, selected_paint_id, ai_recommendations, notes, status)
VALUES
  ('00000000-0000-4000-8000-000000000951', '00000000-0000-4000-8000-000000000101', '00000000-0000-4000-8000-000000000301', '00000000-0000-4000-8000-000000000701', NULL, '[{"fabric":"Linen Cream","confidence":0.92,"reason":"Best match for formal living room"},{"fabric":"Velvet Navy","confidence":0.84,"reason":"High durability and stain resistance"}]'::jsonb, 'Customer prefers light neutral tones.', 'submitted'),
  ('00000000-0000-4000-8000-000000000952', '00000000-0000-4000-8000-000000000102', '00000000-0000-4000-8000-000000000314', '00000000-0000-4000-8000-000000000703', '00000000-0000-4000-8000-000000000803', '[{"fabric":"Cotton Beige","confidence":0.88,"reason":"Matches warm oak interiors"},{"paint":"Satin Oak","confidence":0.79,"reason":"Complements cane backrest"}]'::jsonb, 'Lounge chair for small apartment.', 'vendor_review');
